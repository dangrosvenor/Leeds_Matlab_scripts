function y=equiv_potemp_for_solving_T(TK,qv,P,equiv_potemp_val)
%function y=equiv_potemp_for_solving_qv(T,TK,P,equiv_potemp_val)
...
%e.g. fzero(@equiv_potemp_for_solving_T,[0 5e-3],[],280,800e2,304.18)
