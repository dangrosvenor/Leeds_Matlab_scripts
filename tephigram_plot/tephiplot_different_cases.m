...
%plot_case='grant_CIN_test';

switch plot_case

            
case 'grant_CIN_test'
exname='c:\matlabr12\work\tephigram_plot\profile_from_grant_for_testing_CIN.txt';
...
%	dat=fscanf(fid,'%g',[9 inf]);
    ...
    [CAPE,CIN,HLCL,TLCL,PLCL,CAPE_surf,CIN_surf,CAPE_array,CIN_array]=calc_cape(pdat,tdat,qdat,qsat,zdat);
