...
%
[n_time,nbin,n_gases,time,r_bin,RH,T,c_gases,c_bin,r_dry]=read_data;
n_bins=sum(nbin);
...
% T(n_time)                 L‰mpˆtila (K) ajan funktiona
...
function [n_time,n_bins,n_gases,time,r_bin,RH,T,c_gases,c_bin,r_dry]=read_data
