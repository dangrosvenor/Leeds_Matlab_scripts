...
% H5ATTPUT:  writes an HDF5 attribute
%
% H5ATTPUT(H5FILE,VARNAME,ATTNAME,ATTVALUE) creates/overwrites the attribute
% named ATTNAME with the value ATTVALUE.  The parent object VARNAME can be 
% either an HDF5 variable or group.  VARNAME must be a complete pathname.
%
