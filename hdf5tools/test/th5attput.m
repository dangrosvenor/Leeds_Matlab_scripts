...
fprintf ( 1, 'Creation of a 1D char attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of a 2D char attribute onto a variable succeeded.\n' );
%--------------------------------------------------------------------------
...
delete(hfile);
fprintf ( 1, 'Creation of file (where none existed) succeeded.\n' );
...
fprintf ( 1, 'Creation of an int8 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of a uint8 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of an int16 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of a uint16 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of an int32 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of a uint32 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of an int64 attribute onto a group succeeded.\n' );
...
fprintf ( 1, 'Creation of a uint64 attribute onto a group succeeded.\n' );
