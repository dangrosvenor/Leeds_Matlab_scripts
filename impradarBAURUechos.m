...
%dire='c:/documents and settings/login/my documents/hibiscus/troccibras/radar/bauru/ppi/24.02/';
...
values=[2.0:0.65:20.2 99 NaN NaN]; %values of radar scale (dbZ)

for ii=3:arad  %arad
    ii
    if strcmp('.gif',d(ii).name(end-3:end))==1
    %if strcmp(d(ii).name,'ppi_bru_240204_2100h.gif')==1
        date(ii).d=(d(ii).name(11:21));
