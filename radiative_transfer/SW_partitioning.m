function [dSW_f,dSW_W,dSW_N,Ac,tau,A,SW_out] = SW_partitioning(f0,W0,N0,f1,W1,N1,SW_in,A_clear,trans)
% Nd in cm3
% W in g/m2
% SW_in in W/m2
...
A = Ac.*f0 + A_clear.*(1-f0);
SW_out = SW_in .* A .*trans;

% Removed teh below to a separate function
