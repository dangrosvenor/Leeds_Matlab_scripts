...
function [mask_5km,qapq_5km,qapp_5km] = flagread_5km_Dan(mask5,qa5)
...
%    
   ...
   qapq_5km(3,:,:)  = bitand( bitshift(qa5(1,:,:),-4) , 1 );
...
% 			0: missing% 1: no cirrus found% 2: cirrus found
%  qapp_5km(1)  :  HIGH CLOUD LEVEL 3 FLAG
%			0: missing% 1: no high cld found% 2: high cld found
