...
csatindx = load_am3('csatindx','(:)',nc_inst,gcm_idays); %height of CFAD bins (metres)
...
%gcm_prec3D = load_am3('lscale_rain3d','(gcm_idays,:,:,:)',nc_inst,gcm_idays);
%gcm_prec3D = gcm_prec3D/1e3;

%gcm_prec3D_snow = load_am3('lscale_snow3d','(gcm_idays,:,:,:)',nc_inst,gcm_idays);
