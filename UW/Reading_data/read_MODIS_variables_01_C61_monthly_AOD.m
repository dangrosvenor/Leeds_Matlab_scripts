...
%MODIS_varname='Cloud_Retrieval_Fraction_Liquid'; nvar = hdfsd('nametoindex',SD_id,MODIS_varname)+1; %(nvar=434);
%MODIS_varname='Cloud_Retrieval_Fraction_Ice'; nvar = hdfsd('nametoindex',SD_id,MODIS_varname)+1; %(nvar=434);
%MODIS_varname='Cloud_Retrieval_Fraction_Undetermined'; nvar = hdfsd('nametoindex',SD_id,MODIS_varname)+1; %(nvar=434);
%MODIS_varname='Cloud_Retrieval_Fraction_Combined'; nvar = hdfsd('nametoindex',SD_id,MODIS_varname)+1; %(nvar=434);
...
%Monthly AOD
 modis_var{istring}='AOD_550_Dark_Target_Deep_Blue_Combined_Mean_Mean'; istring=istring+1; %(nvar=434);
...
% modis_var{istring}='Cloud_Retrieval_Fraction_Liquid'; istring=istring+1; %(nvar=434);
% modis_var{istring}='Cloud_Retrieval_Fraction_Liquid_Pixel_Counts'; istring=istring+1; %(nvar=21)  %N.B. this is exactly the same as totN
% %from the joint histo
% modis_var{istring}='Cloud_Retrieval_Fraction_Ice_Pixel_Counts'; istring=istring+1; %(nvar=21)  %N.B. this is exactly the same as totN
% 
% modis_var{istring}='Cloud_Retrieval_Fraction_Ice'; istring=istring+1; %(nvar=436)
% modis_var{istring}='Cloud_Retrieval_Fraction_Undetermined'; istring=istring+1; %(nvar=438)
% modis_var{istring}='Cloud_Retrieval_Fraction_Combined'; istring=istring+1; %(nvar=440)
% %Cloud effective radius and optical thickness are all MOD06 products
% 
% %MOD35 cloud mask products
% modis_var{istring}='Cloud_Fraction_Mean'; istring=istring+1; %Day and night mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Standard_Deviation'; istring=istring+1; %Day and night mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Pixel_Counts'; istring=istring+1; %Day and night mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Day_Mean'; istring=istring+1; %Day mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Day_Standard_Deviation'; istring=istring+1; %Day mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Day_Pixel_Counts'; istring=istring+1; %Day mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Night_Mean'; istring=istring+1; %night mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Night_Standard_Deviation'; istring=istring+1; %night mean CF (MOD35)
% modis_var{istring}='Cloud_Fraction_Night_Pixel_Counts'; istring=istring+1; %night mean CF (MOD35)
% 
% %No QA fields in C6 - all odne using pixel level uncertainty
...
% 
% %New 1.6 and 3.7um retrievals
% modis_var{istring}='Cloud_Effective_Radius_16_Liquid_Mean'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_16_Liquid_Standard_Deviation'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_16_Liquid_Minimum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_16_Liquid_Maximum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_16_Liquid_Mean_Uncertainty'; istring=istring+1; %(nvar=397)
% 
% modis_var{istring}='Cloud_Effective_Radius_37_Liquid_Mean'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_37_Liquid_Standard_Deviation'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_37_Liquid_Minimum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_37_Liquid_Maximum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_37_Liquid_Mean_Uncertainty'; istring=istring+1; %(nvar=397)
% 
% modis_var{istring}='Cloud_Effective_Radius_1621_Liquid_Mean'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_1621_Liquid_Standard_Deviation'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_1621_Liquid_Minimum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_1621_Liquid_Maximum'; istring=istring+1; %(nvar=397)
% modis_var{istring}='Cloud_Effective_Radius_1621_Liquid_Mean_Uncertainty'; istring=istring+1; %(nvar=397)

%Note, there is now a 1621 retrieval too - read about this.
...
%Called this in C6:-
%modis_var{istring}='Cloud_Optical_Thickness_Liquid_JHisto_vs_Eff_Radius'; istring=istring+1; 
...
%  -- Don't seem to be present for C6
...
%switch collection
    %case 'C6'
    %    nvar = hdfsd('nametoindex',SD_id,'Cloud_Retrieval_Fraction_Liquid')+1;
    %case 'C61_Monthly'
        nvar = hdfsd('nametoindex',SD_id,'Cloud_Retrieval_Fraction_Liquid_FMean')+1;
%end
...
for iread_modis=1:length(modis_var)
    ...
    %Now convert to the old C5 names for consisttency for certain C6 variables that have
    %changed name
    
    iret = strfind(MODIS_varname,'_Retrieval');
    if length(iret)>0
        %Replace the _Retrieval with nothing to turn
        %Cloud_Retrieval_Fraction into Cloud_Fraction
        MODIS_varname=remove_character(MODIS_varname,'_Retrieval','');
        %set this too since this list is used for saving in
        %save_MODIS_L3_data
        modis_var{iread_modis} = MODIS_varname;
    end
    
    %Other variable names to convert
    switch MODIS_varname      
        case 'Cloud_Optical_Thickness_Liquid_Joint_Histogram_vs_Effect_Radius'
            MODIS_varname =  'Cloud_Optical_Thickness_Liquid_Joint_Histogram_vs_Effect_Radius';
