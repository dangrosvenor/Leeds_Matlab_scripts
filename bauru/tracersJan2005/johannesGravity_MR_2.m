...
maxMRImpc=max(icemrmpc(xim:xim2,1,zim:zim2,:),[],1)*1e3*1e6/f;
maxMRImpc=squeeze(max(maxMRImpc,[],3)); %timeseries of max number conc
...
meanMRImpc=squeeze(mean(meanMRImpc,3)); %timeseries of mean number conc
