...
function [f0,N0,W0,f1,N1,W1,N0_2,W0_2,N1_2,W1_2] = calc_cloud_variables_for_SW_TOA_calc(low_CF_PI_ALL,Nd_PI_ALL,LWP_PI_ALL,low_CF_PD_ALL,Nd_PD_ALL,LWP_PD_ALL,cf_min)

f0 = low_CF_PI_ALL; f1 = low_CF_PD_ALL;
N0 = Nd_PI_ALL/1e6; N1 = Nd_PD_ALL/1e6; %convert to per cc for calc_SW function
W0 = LWP_PI_ALL./f0; W1 = LWP_PD_ALL./f1; %Need to supply the in-cloud LWP, so divide by low CF
%cf_min = 0.01;
