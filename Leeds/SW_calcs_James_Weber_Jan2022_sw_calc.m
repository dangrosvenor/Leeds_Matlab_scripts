function [SWTOA_calc_model,SWTOA_calc_model_annual,SWTOA_clear_sky_calc_model,SWTOA_clear_sky_calc_model_annual] = SW_calcs_James_Weber_Jan2022_sw_calc(SW_up_TOA_clear_sky,f_upscatter,trans_clear_sky,cf,lwp,nd,sw,surf_albedo,tr_for_SW_bias,tr_atmos_constant_val,fac_SWin,cf_min);
