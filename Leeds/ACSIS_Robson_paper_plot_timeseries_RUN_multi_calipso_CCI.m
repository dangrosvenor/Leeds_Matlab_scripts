...
%model trend start year

yr_start_trend_box = [1985]; %CCI CF
%yr_start_trend_box = [1850]; %CCI CF
...
ioverride_obs_trend_yr_start=1; %if =1 then uses yr_trend_obs_start otherwise uses start of 
%obs period
...
ACSIS_Robson_paper_plot_timeseries_totCF_CCI_and_CALIPSO %plots CCI and CALIPSO together
