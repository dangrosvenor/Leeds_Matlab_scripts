...
isave = 1;
save_dir = '/home/disk/eos15/d.grosvenor/UM/James_Weber/James_King_CESM/';

iload = 1;

%% Load the input data from James's NetCDFs.
if iload==1
    SW_calcs_James_King_CESM_Nov2022_load_input_data
end

%% Run some setup of methods, etc.
SW_calcs_James_King_Nov2022_setup
...
[SWTOA_calc_model,SWTOA_calc_model_annual,SWTOA_clear_sky_calc_model,SWTOA_clear_sky_calc_model_annual] = SW_calcs_James_King_Nov2022_sw_calc(sw_clear,f_upscatter,trans_clear_sky,cf,lwp,nd,sw_in,surf_albedo,tr_for_SW_bias,tr_atmos_constant_val,fac_SWin,cf_min,i_Liu);
...
[SWTOA_calc_model_PD,SWTOA_calc_model_annual_PD,SWTOA_clear_sky_calc_model_PD,SWTOA_clear_sky_calc_model_annual_PD] = SW_calcs_James_King_Nov2022_sw_calc(sw_clear,f_upscatter,trans_clear_sky,cf,lwp,nd,sw_in,surf_albedo,tr_for_SW_bias,tr_atmos_constant_val,fac_SWin,cf_min,i_Liu);

            
%% PI clouds with PD Nd.
cf = dat_PI.totCF;
nd = dat_PD.Nd; %per cc
lwp = dat_PI.lwp_ic; %kg/m3
sw_clear = dat_PI.SW_up_TOA_clear_sky;
sw_in = dat_PI.SW_down_TOA;

[SWTOA_calc_model_PI_PD_Nd,SWTOA_calc_model_annual_PI_PD_Nd,SWTOA_clear_sky_calc_model_PI_PD_Nd,SWTOA_clear_sky_calc_model_annual_PI_PD_Nd] = SW_calcs_James_King_Nov2022_sw_calc(sw_clear,f_upscatter,trans_clear_sky,cf,lwp,nd,sw_in,surf_albedo,tr_for_SW_bias,tr_atmos_constant_val,fac_SWin,cf_min,i_Liu);
...
[SWTOA_calc_model_PD_PI_Nd,SWTOA_calc_model_annual_PD_PI_Nd,SWTOA_clear_sky_calc_model_PD_PI_Nd,SWTOA_clear_sky_calc_model_annual_PD_PI_Nd] = SW_calcs_James_King_Nov2022_sw_calc(sw_clear,f_upscatter,trans_clear_sky,cf,lwp,nd,sw_in,surf_albedo,tr_for_SW_bias,tr_atmos_constant_val,fac_SWin,cf_min,i_Liu);
