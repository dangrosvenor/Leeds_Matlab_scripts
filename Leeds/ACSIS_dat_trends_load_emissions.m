function []=ACSIS_dat_trends_load_ensemble()

var_UM = 'SO2_low_anthropogenic_emissions';
...
savefile_pre_str = ['/home/disk/eos1/d.grosvenor/modis_work/ACSIS_Nd_trends/ensemble_timeseries_ukesm_' output_period];
...
iens=2;
dat_ens(iens,:,:,:) = dat_global.dat; %dummy data for ensemble just in case
