...
%herr=errorbarYY('horiz',val,x,uncer,gca,bar_cols{1},'o',3,0.005);
ytick_labs{i}='ERF_{Nd}';
...
plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{1},'markersize',msize);
%herr=errorbarYY('horiz',val,x,uncer,gca,bar_cols{1},'o',3,0.005);
ytick_labs{i}='ERF_{cloud fraction}';
...
if iagu==0
    ...
    switch vars{ivar}
        case 'SW'
            ...
            plot(val,x,'s','color',bar_cols{1},'markerfacecolor',bar_cols{2});
            ...
            plot(val,x,'^','color',bar_cols{1},'markerfacecolor',bar_cols{2});
            %herr=errorbarYY('horiz',val,x,uncer,gca,'b','o',3,0.005);
            ...
            plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{2},'markersize',12);
            %herr=errorbarYY('horiz',val,x,uncer,gca,'b','o',3,0.005);
            ...
            plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{5});
            %herr=errorbarYY('horiz',val,x,uncer,gca,'b','o',3,0.005);
            ...
            plot(val,x,'s','color',bar_cols{1},'markerfacecolor',bar_cols{5});
            %herr=errorbarYY('horiz',val,x,uncer,gca,'b','o',3,0.005);
            ...
            plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{10});
            %herr=errorbarYY('horiz',val,x,uncer,gca,'b','o',3,0.005);
            ...
            plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{9});
            %herr=errorbarYY('horiz',val,x,uncer,gca,bar_cols{1},'o',3,0.005);
...
if iagu==0
    ...
    plot(val,x,'o','color',bar_cols{1},'markerfacecolor',bar_cols{1});
    herr=errorbarYY('horiz',val,x,uncer,gca,bar_cols{1},'o',3,0.005);
