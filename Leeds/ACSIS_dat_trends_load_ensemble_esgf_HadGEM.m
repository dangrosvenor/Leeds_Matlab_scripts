function []=ACSIS_dat_trends_load_ensemble_esgf_HadGEM(var_UM)

output_period = 'all';
%output_period = 'recent';
%output_period = 'SW_down_TOA_partial';

model='HadGEM-GC31-MM';
%model='HadGEM-GC31-LL';
...
dir_data = ['/home/disk/eos15/d.grosvenor/UM/HadGEM-GC31/' model '/historical/'];
%Directory to save to
savefile_pre_str = ['/home/disk/eos1/d.grosvenor/modis_work/ACSIS_Nd_trends/EGSF_' model '_ensemble_timeseries_' output_period ens_str];
