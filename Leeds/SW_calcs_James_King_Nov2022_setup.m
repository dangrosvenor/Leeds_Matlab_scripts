...
tr_atmos_constant_val = 0.89; %Used for James Weber study Jan 2022
tr_atmos_constant_val = 0.8;  %James King/Weber study Nov 2022

%tr_atmos_constant_val = 0.734; %attempt to get this to match using cloudy-sky trans scaling only.

cf_min = 0.01;
i_Liu = 0; %set to zero for CESM since this model doesn't use it.
