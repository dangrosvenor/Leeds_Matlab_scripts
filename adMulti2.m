...
if fla==5
    Tdat=pr(1).p(:,3);
    Pdat=pr(1).p(:,2);
    rhstart=pr(1).p(1,4); %relative humidity at ground (%)
    Hdat=pr(1).p(:,1);
...
for i=1:ans(2)
   ...
   h=plot( x,(y) ,'--'); %lines of constant theta
...
[xx1,yy1]=rotatedan2(123,log10(513.67),thi,Y,minT,minTH,maxTH); 
[xx2,yy2]=rotatedan2(313,log10(313),thi,Y,minT,minTH,maxTH);

axis( [xx1 xx2 yy2 yy1] ); %zoom into area of interest
set(gca,'XTicklabel','');
