...
function [H1,ax1,ax2]=plotXY3(xdat,ydat,labs,nmark,lwidth,leglor,logflag,xlab,ylab,xlims,ylims,zline,nxt,nyt) %xdat(1:n).x, ydat(1:n).y & labs(1:n).l nmark=no markers
