%% --- Run this from DRIVER_plot_global_maps in order to set default values
%%      for plot_global_maps
...
%year.
% Uses load_saved_modis_vars_20150130
...
%% What to plot in plot_global_maps
...
%Set_screening determines how many screening types to use.
