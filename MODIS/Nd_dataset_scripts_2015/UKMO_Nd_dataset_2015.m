...
file01 = '/home/disk/eos1/d.grosvenor/saved_misc_mat_files/MODIS_TERRA_Nd_QA_from_L3_daily_UKESM_Jane_2000_2014_20150619T063935.mat';
...
switch choose_filtering
    case 'CTT_gt_273 CF>80'
        ...
        switch choose_years
            ...
            otherwise
                savefile01 = [savedir01 'MODIS_TERRA_Nd_QA_from_L3_daily_UKESM_Jane_2000_2014_CF80_CTT273_20150416T063530.mat'];
        end
...
%        var_tag = '_CTT_gt_273_CF_gt_80';
    ...
    case 'CTT_gt_273 allCF'
        ...
        switch choose_years
            ...
            otherwise
                savefile01 = [savedir01 'MODIS_TERRA_Nd_QA_from_L3_daily_UKESM_Jane_2000_2014_allCF_CTT273_region_mask_20150416T063530.mat'];
        end
