function [time,sst,wspdLF,wspdMF,vapor,cloud,rain]=read_amsr_day_v7(data_file)
...
%note the negative offset for cloud (lwp, offset no. 6 = -0.05) - is negative because they take
