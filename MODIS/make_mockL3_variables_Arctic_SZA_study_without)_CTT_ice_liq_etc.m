...
%The below is not available for the Arctic dataset - is the number of
%pixels that were designated as single liquid layers. Used to restrict to
%such clouds in the Puijo study - not sure how?
