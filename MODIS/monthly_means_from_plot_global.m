...
%    multi_case = 'Seasonal';
    ...
    %plot_script = 'plotTimeHeightVap3';
...
%    proj_type = 'global oval';
    ...
    %set the variable to use in plot_global_maps
    modis_data_plot = 'Number of droplets 1km values time mean'; %using 1km re and tau values to make Nd, then averaging to 1deg
