...
%% Make sure that this is set properly, so that previous files are not
%% overwritten, etc.
...
UM_time_in.varname = 'SW_up_TOA'; %newer files have it called this
UM_time_in.varname = 'SW_TOA_outgoing'; %older ones this...

UM_time_in.var_units_str = 'W m^{-2}'; %may want to set this where set nc_varname, etc.

%Choose the lat lon required - not required if UM_time_in.irestrict_domain_DRIVER=0
...
%UM_time_in.time_range =  [datenum('31-Aug-2014 00:00') datenum('05-Sep-2014 21:02')];
