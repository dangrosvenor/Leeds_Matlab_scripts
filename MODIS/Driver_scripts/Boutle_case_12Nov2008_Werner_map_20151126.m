...
%Have saved the Dtot array for xmmz-u (CASIM-Ndvar run) in /home/disk/eos8/d.grosvenor/UM/12Nov2008_Boutle/xmmz-u/xmmz-u_Dtot.mat
save_name_Dtot = '/home/disk/eos8/d.grosvenor/UM/12Nov2008_Boutle/xmmz-u/xmmz-u_Dtot.mat';
%can load this in case don't want to calculate it :-  load(save_name_Dtot)
...
%      [lwp,time_matlab,gcm_Plat2D_UM,gcm_Plon2D_UM,gcm_Plat2D_edges_UM,gcm_Plon2D_edges_UM,it_driver,daynum_timeseries3_UM,modisyear_timeseries3_UM,gcm_time_UTC_UM,gcm_time_matlab_UM] = get_LWP_RWP_UM(vars_in);
    ...
    for it_driver=1:1 %1:length(time_matlab)  %4:nt_driver
        ...
        %Calculate the data to plot
        dat_modis = squeeze(lwp(:,:)); %already in g/m2
        ...
        titlenam_driver = ['LWP for ' time_str];        
        units_str_plot = 'g m^{-2}';
        
        titlenam_driver = ['Werner metric'];        
        units_str_plot = '';        
