...
fig_3panel_savename = 'est_contrib';
...
%% ----  Nd ---------------------------
    ...
    %um_data = 
    dat_load = load([savedir_date 'Change_in_surface_SW_due_to_Nd_PI+PD_average.mat']);
...
%% ----  LWPic ---------------------------
    ...
    dat_load = load([savedir_date 'Change_in_surface_SW_due_to_LWP_PI+PD_average.mat']);
    dat_modis = dat_load.plot_data;
    gcm_Plat2D_GENERIC = dat_load.lat_data;
    gcm_Plon2D_GENERIC = dat_load.lon_data;
    gcm_Plat2D_edges_GENERIC = dat_load.lat_data_edges;
...
%% ----  CF contribuiton ---------------------------
    ...
    dat_load = load([savedir_date 'Change_in_surface_SW_due_to_CF_PI+PD_average.mat']);
    dat_modis = dat_load.plot_data;
    gcm_Plat2D_GENERIC = dat_load.lat_data;
    gcm_Plon2D_GENERIC = dat_load.lon_data;
    gcm_Plat2D_edges_GENERIC = dat_load.lat_data_edges;
