...
fig_3panel_savename = 'est_percent_contrib';
...
%% ----  Nd ---------------------------
    ...
    %um_data = 
    dat_load = load([savedir_date 'Percentage_of_abs_forcing_from_DeltaNd_using_PI+PD_baseline_average.mat']);
...
%% ----  LWPic ---------------------------
    ...
    dat_load = load([savedir_date 'Percentage_of_abs_forcing_from_DeltaLWP_using_PI+PD_baseline_average.mat']);
    dat_modis = dat_load.plot_data;
    gcm_Plat2D_GENERIC = dat_load.lat_data;
    gcm_Plon2D_GENERIC = dat_load.lon_data;
    gcm_Plat2D_edges_GENERIC = dat_load.lat_data_edges;
...
%% ----  CF contribuiton ---------------------------
    ...
    dat_load = load([savedir_date 'Percentage_of_abs_forcing_from_DeltaCF_using_PI+PD_baseline_average.mat']);
    dat_modis = dat_load.plot_data;
    gcm_Plat2D_GENERIC = dat_load.lat_data;
    gcm_Plon2D_GENERIC = dat_load.lon_data;
    gcm_Plat2D_edges_GENERIC = dat_load.lat_data_edges;
...
%Need to sort move the colourbars separately    
    ...
    pos(3)=0.63; %width of the 1st colourbar
