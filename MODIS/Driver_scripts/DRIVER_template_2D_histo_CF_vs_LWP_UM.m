...
Ybins_DRIVER = [-dcf/2:dcf:1+dcf/2]; ichoose_Ybins_DRIVER=1; %cloud fraction
Ybins_DRIVER = [0:dcf:1]; ichoose_Ybins_DRIVER=1; %cloud fraction
%Ybins_DRIVER = [0 0.05:dcf:0.95 1]; ichoose_Ybins_DRIVER=1; %cloud fraction - as for CPT VOCALS plot

switch LWP_type
    case 'Grid-box mean'
        %Xbins_DRIVER = [5:20:500 1e4]; ichoose_Xbins_DRIVER=1; %LWP in-cloud
        Xbins_DRIVER = [-20 10.^[log10(1):0.05:log10(1e4)]]; ichoose_Xbins_DRIVER=1; %LWP grid box mean
        Xbins_DRIVER = [10.^[log10(0.9):0.05:log10(1e4)]];
        Xbins_DRIVER = [10.^[log10(20):0.05:log10(1e4)]];
        %Xbins_DRIVER = [-20 10:10:200]; ichoose_Xbins_DRIVER=1; %LWP grid box mean
    case 'In-cloud'
        Xbins_DRIVER = [-20 10.^[log10(1):0.05:log10(1e4)]]; ichoose_Xbins_DRIVER=1; %LWP grid box mean
        Xbins_DRIVER = [10.^[log10(0.9):0.05:log10(1e4)]];
end
