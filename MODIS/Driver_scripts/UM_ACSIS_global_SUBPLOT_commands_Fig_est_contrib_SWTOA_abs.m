...
fig_3panel_savename = 'est_contrib_SWTOA_abs';
...
%% ----  Nd ---------------------------
    ...
    %um_data = 
    dat_load = load([savedir_date 'Contribution_to_abs_SW_TOA_bias_from_Nd_bias_(pct).mat']);
...
%% ----  LWPic ---------------------------
    ...
    dat_load = load([savedir_date 'Contribution_to_abs_SW_TOA_bias_from_LWPic_bias_(pct).mat']);
    dat_modis = dat_load.plot_data;
...
%% ----  CF contribuiton ---------------------------
    ...
    dat_load = load([savedir_date 'Contribution_to_abs_SW_TOA_bias_from_CF_bias_(pct).mat']);
    dat_modis = dat_load.plot_data;
