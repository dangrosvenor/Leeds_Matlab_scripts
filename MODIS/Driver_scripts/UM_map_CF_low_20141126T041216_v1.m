...
UM_map.varname = 'Low_CF'; %The name of the variable in the nc file
%UM_map.varname = 'Mid_CF'; %The name of the variable in the nc file
UM_map.varname = 'High_CF'; %The name of the variable in the nc file
UM_map.varname = 'tot_CF_max_rand'; %The name of the variable in the nc file
...
UM_map.fileUM{idat} = '/u-ad234/u-ad234_Cloud_CFs_.pp.nc'; UM_map.labs_UM(idat).l = 'u-ad234'; UM_map.pole_lat=25; UM_map.pole_lon=165;
    UM_map.line_patternUM(idat).p= '--';  UM_map.line_colourUM(idat).c=[0.4 0.4 0.4]; UM_map.marker_styleUM(idat).m='d'; idat=idat+1;
