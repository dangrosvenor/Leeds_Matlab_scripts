...
%UM_time_in.UM_cases = '12th Nov case, as of May 2016 processing runs multi-dirUM';
%UM_time_in.UM_cases = '12th Nov case, as of May 2016 adhoc multi-dirUM';
UM_time_in.UM_cases = '12th Nov case, as of May 2016 processing runs PLOTS multi-dirUM';
...
%UM_time_in.action='time_mean_2D'; %timeseries (i.e. of 2D domain mean) is output automatically, so may as well set this to get the 
  %time mean of this too.
