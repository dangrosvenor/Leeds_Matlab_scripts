...
%    lwp_weighted  = sum( CF_0pt25_LWP_4km_20(i).timeseries_UM(1:end-1) .* w ) ./ sum(w);
    lwp_weighted  = sum( CF_LWP_20(i).timeseries_UM(1:end-1) .* w ) ./ sum(w);
...
Processing_overall_LWP_ACI_v2_make_subplot_v2
