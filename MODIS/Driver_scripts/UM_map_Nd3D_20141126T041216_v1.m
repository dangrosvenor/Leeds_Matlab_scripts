...
UM_map.varname = 'Nd_3D'; %The name of the variable in the nc file
...
UM_map.iz = 40; %=3km for Iceland case (can do z_um = nc{'hybrid_ht'}(:); to check (using previously opened nc file)
...
UM_map.fileUM{idat} = '/u-ad571/u-ad571_Nd_.pp.nc'; UM_map.labs_UM(idat).l = 'u-ad571, low aerosol, volcano ON'; UM_map.pole_lat=25; UM_map.pole_lon=165;
    UM_map.line_patternUM(idat).p= '--';  UM_map.line_colourUM(idat).c=[0.4 0.4 0.4]; UM_map.marker_styleUM(idat).m='d'; idat=idat+1;
UM_map.fileUM{idat} = '/u-ad572/u-ad572_Nd_.pp.nc'; UM_map.labs_UM(idat).l = 'u-ad572, low aerosol, volcano OFF'; UM_map.pole_lat=25; UM_map.pole_lon=165;
    UM_map.line_patternUM(idat).p= '--';  UM_map.line_colourUM(idat).c=[0.4 0.4 0.4]; UM_map.marker_styleUM(idat).m='d'; idat=idat+1;
