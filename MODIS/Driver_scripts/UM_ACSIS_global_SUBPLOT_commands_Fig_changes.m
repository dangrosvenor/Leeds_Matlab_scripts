...
%% ----  Nd ---------------------------
    ...
    %um_data = 
    dat_load = load([savedir_date 'Percentage_change_in_Nd_(PD_minus_PI).mat']);
...
%% ----  LWPic ---------------------------
    ...
    dat_load = load([savedir_date 'Percentage_change_in_in-cloud_LWP_(PD_minus_PI).mat']);
    dat_modis = dat_load.plot_data;
...
%% ----  CF contribuiton ---------------------------
    ...
    dat_load = load([savedir_date 'Percentage_change_in_cloud_fraction_(PD_minus_PI).mat']);
    dat_modis = dat_load.plot_data;
