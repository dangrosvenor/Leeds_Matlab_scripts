...
Xbins_DRIVER = [-dcf/2:dcf:1+dcf/2]; ichoose_Xbins_DRIVER=1; %cloud fraction PI
...
ioverall_contribution_mean_2D = 1; %Make it plot the overall contribution rather than the mean in each bin
