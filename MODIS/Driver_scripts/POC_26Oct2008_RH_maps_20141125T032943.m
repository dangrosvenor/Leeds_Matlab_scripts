...
clim_driver = [50 100]; %Default for climits
...
vars_UM{idat}='qv'; idat=idat+1;
vars_UM{idat}='exner'; idat=idat+1;
vars_UM{idat}='theta'; idat=idat+1;
...
%        [nc,time_out,gcm_Plat2D_UM,gcm_Plon2D_UM,gcm_Plat2D_edges_UM,gcm_Plon2D_edges_UM,it,daynum_timeseries3_UM,modisyear_timeseries3_UM,gcm_time_UTC_UM,gcm_time_matlab_UM] = read_UM_file(filename,time,pole_lat,pole_lon);
        ...
        dat_modis = var_out*100; %convert to %
        ...
        titlenam_driver = ['Mean RH for z.LT.1 km ' time_str ' ' labs_UM(idat_UM).l];
        units_str_plot = '%';
