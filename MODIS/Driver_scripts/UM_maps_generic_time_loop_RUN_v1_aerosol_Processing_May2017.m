...
UM_time_in.UM_cases = 'Iceland_9day_runs_Nov2016 adhoc';
%UM_time_in.UM_cases = 'Iceland_9day_runs_Nov2016 - volcanoes ON only';
UM_time_in.UM_cases = '12th Nov case, as of Feb 2017 processing runs PLOTS multi-dirUM';
UM_time_in.UM_cases = '12th Nov case, as of May 2017 processing runs surface fluxes, delaying processing, etc.';

%Choose the variable
%UM_time_in.varname = 'LWP';
%UM_time_in.varname = 'RWP';
%UM_time_in.varname = 'SW_up_TOA';
%UM_time_in.varname = 'accum_num_z3000';
%UM_time_in.varname = 'accum_mass_z3000';
%UM_time_in.varname = 'accum_mass_mean_up_to_z3000';
%UM_time_in.varname = 'accum_number_total_column_to_z1500';
%UM_time_in.varname = 'Total_number_aerosol_droplets_to_z1500m'; %accum + coarse + Nd averaged between zero and 1500m
UM_time_in.varname = 'BL height using RH50';
...
UM_time_in.time_specific =  [datenum('13-Nov-2008 12:00')];
UM_time_in.time_specific =  [datenum('12-Nov-2008 09:00')];
UM_time_in.time_range =  [datenum('12-Nov-2008 00:00') datenum('14-Nov-2008 00:00')];
...
switch UM_time_in.varname
    case'accum_num_z3000'
        ...
        UM_time_in.clim_max=5e9; %or 5000 per cc at rho=1

    case 'accum_mass_mean_up_to_z3000';
        UM_time_in.iset_min_clim=1;
        UM_time_in.clim_min=0;
        UM_time_in.iset_max_clim=1;
        UM_time_in.clim_max=5e-8; %or 5000 per cc at rho=1
        
    case 'RWP'
        UM_time_in.iset_min_clim=1;
        UM_time_in.clim_min=0;
        UM_time_in.iset_max_clim=1;
        UM_time_in.clim_max=100; 
