...
UM_time_in.UM_time_loop_action='output_3D';
...
UM_time_in.UM_cases = 'Iceland_9day_runs_Nov2016_low_background_volcanor_ON_only';
UM_time_in.UM_cases = '12th Nov case, as of May 2016 adhoc multi-dirUM';
%UM_time_in.UM_cases = '12th Nov case, as of May 2016 rain OFF multi-dirUM';
...
%UM_time_in.varname = 'accum_num'; %3D fields direct from .nc file
UM_time_in.varname = vars{ivar_proc}; %from outside script
...
UM_time_in.iz = -1; %Can set a height index for a horiz slice here. Comment out or set to -1 for all heights
...
% UM_time_in.time_range =  [datenum('01-Sep-2014 12:00') datenum('01-Sep-2014 12:00')];
 UM_time_in.time_range =  [datenum('12-Nov-2008 03:00') datenum('12-Nov-2008 09:00')]; 
