...
%Make it generic - this code should work for all variables!
%UM_time_in.varname = %set outside!
...
switch UM_time_in.varname
    ...
    case 'accum_mass_mean_up_to_z3000';
        ...
        UM_time_in.clim_min=0;
        UM_time_in.iset_max_clim=1;
        UM_time_in.clim_max=5e-8; %kg/kg
        
    case 'accum_mass_ug_per_m3_mean_to_z3000';
        UM_time_in.iset_min_clim=1;
        UM_time_in.clim_min=0;
        UM_time_in.iset_max_clim=1;
        UM_time_in.clim_max=30; %ug/kg
...
%UM_time_out{1}.datUM{1} = UM_time_out{1}.datUM{1} * 1e9; %convert from kg/kg to ug/kg
%UM_time_in.var_units_str = '\mug kg^{-1}';
