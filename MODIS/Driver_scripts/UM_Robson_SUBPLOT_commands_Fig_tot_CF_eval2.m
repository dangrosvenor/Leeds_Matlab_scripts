...
fig_3panel_savename = 'tot_CF_eval';

fsize_latlon = 14;  
caxis_range = [0 1]; 

cbar_title{2} = 'Total Cloud Fraction';
cbar_title{1} = 'Bias (%)';
...
ioverride_ticks_DRIVER = 1; %setting to one at the moment gets rid of the tick labels in the maps
...
%% ----  UKESM ---------------------------
    ...
    %um_data = 
    dat_load = load([savedir_date 'UKESM_time-mean_2007_to_2014_calipso_total_cloud_amount.mat']);
...
%% ----  CALIPSO ---------------------------
    ...
    dat_load = load([savedir_date 'CALIPSO_time-mean_2007_to_2014_calipso_total_cloud_amount.mat']);
    dat_modis = dat_load.plot_data;
...
%% ----  Bias ---------------------------
    ...
    dat_load = load([savedir_date 'UKESM_prc_CF_bias_for_2007_to_2014;.mat']);
    dat_modis = dat_load.plot_data;
