...
% N.B. - if changing this, will need to re-do the obs files since these use
% .mat files that were based on the top half of the UM domain.
...
%     
         ...
         vars_in.var = 'RWP';
         vars_in.flag = flag{idat_UM};
         vars_in.file_lwp =  [dirUM remove_character(fileUM{idat_UM},'LWP','RWP')];   %Keep as file_lwp for loading .mat files         
...
%overall means    
    ...
    RWP_overall_mean(idat_driver) = meanNoNan(lwp_temp(:),1);    
...
%save(save_overall_file,'-APPEND','RWP_overall_mean','time','time_matlab','it_overall','labs');


%save_overall_file = '/home/disk/eos8/d.grosvenor/UM/12Nov2008_Boutle/LWP_overall_20160707T103638.mat';
%save(save_overall_file,'-APPEND','RWP_overall_mean');
