...
%         vars_in.file_rho = [dirUM fileUM_rho{idat_UM}]; %filename_rho;
    ...
    for it_driver=22:22 %1:length(time_matlab)  %4:nt_driver
        %12=23:00 UTC on 12th, 16 = 07:00UTC on 13th = 02:00 LST on 13th;  22=19:00 on 13th; 
        ...
        titlenam_driver = ['Nd for ' time_str];
        units_str_plot = 'cm^{-3}';
