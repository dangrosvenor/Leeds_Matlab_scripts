    ...
    switch modis_data_type
        ...
        case 'mock_L3_C5_raw' %mock L3 files as processed
            switch date_str 
                ...
                otherwise
                    error('DPG - Set a MODIS file for this date');
            end
