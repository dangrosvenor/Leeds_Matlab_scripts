...
%% Start by running loading in data that was created by the indicated
%% script
...
UM_map.isave_plot=0; %also closes the plot
...
%Inverted differences for comparison plot to Jim's paper where the SW must
%be the downward SWTOA
% idiff_cases{1}(1)=1; %Low aerosol, volcano ON
% idiff_cases{1}(2)=3; %Low aerosol, volcano OFF
% idiff_cases{2}(1)=4; %High aerosol, volcano ON
% idiff_cases{2}(2)=2; %High aerosol, volcano OFF
