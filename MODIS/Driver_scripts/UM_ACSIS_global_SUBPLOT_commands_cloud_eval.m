...
%% ----  Model ---------------------------
    ...
    if iuse_CALIPSO_COSP==1
        subtitle_str='Model (COSP CALIPSO)';
...
%% ----  CALIPSO sat data ---------------------------
    ...
    switch cloud_alt
        case 'Low altitude cloud'
            dat_modis = eval(['meanNoNan(cllcalipso_monthly_AVERAGE(time_inds_CAL' season_str ',:,:),1)/100;']);
        case 'Mid altitude cloud'
            dat_modis = eval(['meanNoNan(clmcalipso_monthly_AVERAGE(time_inds_CAL' season_str ',:,:),1)/100;']);
        case 'High altitude cloud'
            dat_modis = eval(['meanNoNan(clhcalipso_monthly_AVERAGE(time_inds_CAL' season_str ',:,:),1)/100;']);
        case 'Total cloud'
            dat_modis = eval(['meanNoNan(cltcalipso_monthly_AVERAGE(time_inds_CAL' season_str ',:,:),1)/100;']);           
    end
