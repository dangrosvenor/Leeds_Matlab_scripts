...
%Xbins_DRIVER = [-0.05:0.1:1.05]; ichoose_Xbins_DRIVER=1; %cloud fraction PI
Xbins_DRIVER = [0.5:1:8.5]; ichoose_Xbins_DRIVER=1; %cloud state PI (states 1-8)

%Ybins_DRIVER = [-39:2:39]; ichoose_Ybins_DRIVER=1;
%Ybins_DRIVER = [-70:2:0]; ichoose_Ybins_DRIVER=0;
%Ybins_DRIVER = [-0.05:0.1:1.05]; ichoose_Ybins_DRIVER=1; %cloud fraction PD
Ybins_DRIVER = [0.5:1:8.5]; ichoose_Ybins_DRIVER=1; %cloud fraction PD
...
ioverall_contribution_mean_2D = ioverall_contribution_mean_2D_DRIVER; %Make it plot the overall contribution rather than the mean in each bin
