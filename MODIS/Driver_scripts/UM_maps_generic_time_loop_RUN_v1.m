...
UM_time_in.varname = 'accum_number_total_column_to_z1500'; UM_time_in.var_units_str='#/m^{-2}'; 

UM_time_in.UM_time_loop_action='';
...
UM_time_in.time_specific =  [datenum('12-Nov-2008 06:00')];  %
