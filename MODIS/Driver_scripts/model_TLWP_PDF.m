...
% ------- Select whether want LWP or TLWP (LWP+RWP) here ---------       
...
%       var_str_file = 'LWP_PDFs_CAPT_ocean_only';  
       ...
       var_str_file = 'LWP_PDFs_CAPT_ocean_only_2deg'; %Whole region (i.e. not restricted to Sc deck), but with res degraded to degrees         
% ----------------------------------------------------------------  
