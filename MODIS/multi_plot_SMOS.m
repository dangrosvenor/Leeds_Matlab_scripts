%Load in the timeseries3 data and plot several days

iload_DRIVER=1;  %Setting to =0 prevents loading (for testing purposes, e.g. if have already loaded)

%The plan here is to just be able to change the var selection below to use
%this same code for any variable.
var_str_DRIVER = 'Soil_Misiture';
