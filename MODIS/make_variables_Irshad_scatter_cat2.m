...
switch save_or_load
    ...
    case {'save','load','load_special','load_special2'}
...
modis_var{istring}='Nd_DMPS'; field_string{istring}='.timeseries3'; istring=istring+1;
modis_var{istring}='NaccDMPS'; field_string{istring}='.timeseries3'; istring=istring+1;
...
%        modis_var{istring}='Cloud_Top_Temperature_Day_CF_Standard_Deviation'; field_string{istring}='.timeseries3'; istring=istring+1;
 ...
 modis_var{istring}='Combined_Nd_stddev_and_instrument_error'; field_string{istring}='.timeseries3'; istring=istring+1;
