function add_extra_mockL3_to_VOCALS_mat_file_FUNC(dat,file,varname,varname2,ilat,ilon,it_mat,it_pol)
...
eval_str = [varname varname2 '(:,:,it_mat) = squeeze(dat' varname2 '(ilat,ilon,it_pol));'];
eval(eval_str);
