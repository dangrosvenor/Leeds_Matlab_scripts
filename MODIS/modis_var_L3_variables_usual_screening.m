...
modis_var{istring}='Cloud_Fraction_Day_Mean'; field_string{istring}='.timeseries3'; istring=istring+1;%fraction of pixels that were designated cloud, but had no optical retrievals
% .
% 
 modis_var{istring}='Cloud_Effective_Radius_Liquid_Mean'; field_string{istring}='.timeseries3'; istring=istring+1;%(nvar=397)
 modis_var{istring}='Cloud_Effective_Radius_Liquid_QA_Mean'; field_string{istring}='.timeseries3'; istring=istring+1;%(nvar=397) 
...
% 
 ...
 modis_var{istring}='Cloud_Optical_Thickness_Liquid_QA_Mean'; field_string{istring}='.timeseries3'; istring=istring+1;%(nvar=337) 
