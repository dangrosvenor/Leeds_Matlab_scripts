...
%        savevarname{1} = [savedir_var 'timeseries3_data_y2003_AQUA_20150131T180720.mat']; %Added CTT and others (Jan 2015)  
        savevarname{1} = [savedir_var 'timeseries3_data_y2003_AQUA_20160107T050718.mat']; %Added QA fields for Florent (Jan 2016)          
         %% *** make sure that these are set propertly in each case ***
        modis_year = 2003;
        modis_days = [1:365];
        aqua_terra = {'AQUA'};
...
%        savevarname{1} = [savedir_var 'timeseries3_data_y2004_AQUA_20150201T011655.mat'];      %Added CTT and others (Jan 2015)                          
        savevarname{1} = [savedir_var 'timeseries3_data_y2004_AQUA_20160107T085003.mat']; %Added QA fields for Florent (Jan 2016)          
...
%        savevarname{1} = [savedir_var 'timeseries3_data_y2006_AQUA_updated_20130809T191056.mat'];
        savevarname{1} = [savedir_var 'timeseries3_data_y2006_AQUA_updated_20160107T161242.mat'];   %Added QA fields for Florent (Jan 2016)          
...
%         savevarname{1} = [savedir_var 'timeseries3_data_y2007_AQUA_51_20130809T235652.mat']; %w/ MOD35 CFs         
         savevarname{1} = [savedir_var 'timeseries3_data_y2007_AQUA_51_20160107T195420.mat']; %Added QA fields for Florent (Jan 2016)          
...
%            savevarname{1} = [savedir_var 'timeseries3_data_y2008_AQUA_20130205T204348.mat'];  %w/ CT pressures                                   
            savevarname{1} = [savedir_var 'timeseries3_data_y2008_AQUA_20160107T234149.mat']; %Added QA fields for Florent (Jan 2016)                                         
...
%        savevarname{1} = [savedir_var 'timeseries3_data_y2009_AQUA_20130813T153802.mat']; %w/ MOD35 cloud mask
        savevarname{1} = [savedir_var 'timeseries3_data_y2009_AQUA_20160108T033048.mat']; %Added QA fields for Florent (Jan 2016)                 
             %% *** make sure that these are set propertly in each case ***
        modis_year = 2009;
        modis_days = [1:365];
        aqua_terra = {'AQUA'};
...
%            savevarname{1} = [savedir_var 'timeseries3_data_y2010_AQUA_20130813T205154.mat'];  %w/ MOD35 cloud mask 
            savevarname{1} = [savedir_var 'timeseries3_data_y2010_AQUA_20160108T071626.mat']; %Added QA fields for Florent (Jan 2016)                     
%N.B. monthly mean data is combined AQUA and TERRA - is only loaded for the TERRA
...
%         savevarname{1} = [savedir_var 'timeseries3_data_y2011_AQUA_20150129T131324.mat'];
         savevarname{1} = [savedir_var 'timeseries3_data_y2011_AQUA_20160108T110124.mat']; %Added QA fields for Florent (Jan 2016)                  
...
%         savevarname{1} = [savedir_var 'timeseries3_data_y2012_AQUA_20150129T210206.mat'];
         savevarname{1} = [savedir_var 'timeseries3_data_y2012_AQUA_20160108T144720.mat']; %Added QA fields for Florent (Jan 2016)                  
...
%         savevarname{1} = [savedir_var 'timeseries3_data_y2013_AQUA_20150130T042237.mat'];
         savevarname{1} = [savedir_var 'timeseries3_data_y2013_AQUA_20160108T183736.mat']; %Added QA fields for Florent (Jan 2016)                  
...
%         savevarname{1} = [savedir_var 'timeseries3_data_y2014_AQUA_20150130T112546.mat'];
         savevarname{1} = [savedir_var 'timeseries3_data_y2014_AQUA_20160108T222309.mat']; %Added QA fields for Florent (Jan 2016)                  
...
%     savevarname{1} = [savedir_var 'Arctic_summerL2_2007_20W-60E_70-80N_aqua_L2_data_make mock L3 data_20120524T074930.mat'];  %          
    ...
    case 'y2016_AQUA_C61'
        %         savevarname{1} = [savedir_var 'timeseries3_data_y2014_AQUA_20150130T112546.mat'];
        savevarname{1} = [savedir_var 'timeseries3_data_y2016_AQUA_C61_20201020T030446.mat']; %Just Dec 2016 at the moment
    ...
    case 'y2017_AQUA_C61'        
        savevarname{1} = [savedir_var 'timeseries3_data_y2017_AQUA_C61_20201020T040911.mat']; 
