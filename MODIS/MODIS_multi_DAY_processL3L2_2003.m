...
%% most used global ones I think
        daily_averaged_files_loc2=['/home/disk/eos8/d.grosvenor/saved_data_L2/averaged_daily_mockL3/CF_0.8_minCTT_173_ice_allowed_SZA_65/'];  %Data given to Daniel McCoy
...
%Used for Matt C for JJA 2008 comparison in Nd review paper :-
...
%               direcs={'aqua'};  years=[2003 2004]; days={[10:365],[1:366]};
            ...
            direcs={'aqua'};  years=[2010 2014]; days={[122:212],[1:365]}; %Olympus
            direcs={'aqua'};  years=[2011 2015]; days={[122:212],[20:365]}; %Olympus 
            direcs={'aqua'};  years=[2012 2004]; days={[122:366],[1:365]}; %Olympus
            direcs={'aqua'};  years=[2004]; days={[1:366]}; %Challenger
            direcs={'aqua'};  years=[2003]; days={[11:100]}; %Oly batch            
            direcs={'aqua'};  years=[2003]; days={[189 191:365]}; %Challenger batch             
...
clear irun_from_modis_multi_DAY_processL3L2 ino_sst_matching
