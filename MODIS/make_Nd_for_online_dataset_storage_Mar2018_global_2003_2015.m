...
file_dir='/home/disk/eos15/d.grosvenor/mock_L3/CF_0.8_meanCTT_173_meanCTH_3.2km_SZA_65/for_online_storage/'
...
file_save = [file_dir 'Nd37_' num2str(time_vec(1,1)) '_SZA_LT_65_CF_GT_80_CTH_LT_3.2km.mat'];

%save(file_save,'-V7.3','Nd','time','lon','lat','Nd_1km','Notes','make_mockL3_variables_script_name','multiL2L3_case','multiL2L3_project','daily_averaged_files_loc2');
save(file_save,'-V7.3','Nd','time','time_vec','lon','lat','Notes');
mat2nc_Dan(file_save,[file_save '.nc']);
