...
%  direcs={'aqua'};  years=[2010]; days={[30]};
  ...
  %direcs={'aqua'};  years=[2010]; days={[1:10]};  %Rosenfeld tests
  
  %direcs={'aqua'};  years=[2009 2010]; days={[1:365],[1:365]};  %re-processed years for Rosenfeld MOD35 cloud fraction analysis
