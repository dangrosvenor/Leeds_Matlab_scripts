...
nc_dir = '/home/disk/margaret/hillmanb/nobackup/climate_observations/ceres-ebaf/cmor/climo/';
...
nc_inst_file = ['rlut_ANN.nc']; gcm_str='CERES_CMOR_ANN';
...
toa_LW_outgoing_ceres = read_calipso_cmor(nc_dir,nc_inst_file,'rlut',ilat,ilon,'(:,ilat,ilon)'); 
...
nc_inst_file = ['rlutcs_ANN.nc']; gcm_str='CERES_CMOR_ANN';
toa_LW_outgoing_clearsky_ceres = read_calipso_cmor(nc_dir,nc_inst_file,'rlutcs',ilat,ilon,'(:,ilat,ilon)'); 

nc_inst_file = ['rsdt_ANN.nc']; gcm_str='CERES_CMOR_ANN';
toa_SW_incoming_ceres = read_calipso_cmor(nc_dir,nc_inst_file,'rsdt',ilat,ilon,'(:,ilat,ilon)'); 

nc_inst_file = ['rsut_ANN.nc']; gcm_str='CERES_CMOR_ANN';
toa_SW_outgoing_ceres = read_calipso_cmor(nc_dir,nc_inst_file,'rsut',ilat,ilon,'(:,ilat,ilon)'); 

nc_inst_file = ['rsutcs_ANN.nc']; gcm_str='CERES_CMOR_ANN';
toa_SW_outgoing_clearsky_ceres = read_calipso_cmor(nc_dir,nc_inst_file,'rsutcs',ilat,ilon,'(:,ilat,ilon)'); 
