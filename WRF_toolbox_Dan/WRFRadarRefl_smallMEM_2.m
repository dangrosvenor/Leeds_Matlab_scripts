function Z=WRFRadarRefl_smallMEM(nc,time,scheme,ilat,ilon,iz)
...
elseif nargin==4
    ...
    single=0;
    iz=ilat;   %NOTE - here the input of ilat above will be the iz (height) index
elseif nargin==6
    single=1;
    profile=0;
    horiz_slice=0;    
...
% p =WRFUserARW(nc,'p',time,iz);
% tc=WRFUserARW(nc,'tc',time,iz);
% 
% if horiz_slice==0
%     p=p(ilat,ilon);
%     tc=tc(ilat,ilon);
...
elseif  horiz_slice==0 & profile==1 & single==0    
    p =WRFUserARW(nc,'p',time,ilat,ilon);
    tc=WRFUserARW(nc,'tc',time,ilat,ilon);
elseif  horiz_slice==0 & profile==0 & single==1    
    p =WRFUserARW(nc,'p',time,ilat,ilon,iz);
    tc=WRFUserARW(nc,'tc',time,ilat,ilon,iz);
end
...
if  horiz_slice==0 & profile==0 & single==0
	QG=nc{'QGRAUP'}(time,:,:,:);
elseif horiz_slice==1 & profile==0 & single==0
    QG=nc{'QGRAUP'}(time,iz,:,:);
elseif  horiz_slice==0 & profile==1 & single==0    
    QG=nc{'QGRAUP'}(time,:,ilat,ilon);
elseif  horiz_slice==0 & profile==0 & single==1    
