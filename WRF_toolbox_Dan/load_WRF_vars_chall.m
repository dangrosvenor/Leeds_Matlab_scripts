...
switch wrf_domain_case
    case {'d01','d02'}
        dire(1).dir = '/home/disk/eos10/d.grosvenor/WRF_runs_Ant_Fohn/';
        dire(2).dir = '/home/disk/eos10/d.grosvenor/WRF_runs_Ant_Fohn/';
    case 'd03'
        dire(1).dir = '/home/disk/eos8/d.grosvenor/WRF/';
        dire(2).dir = '/home/disk/eos8/d.grosvenor/WRF/';
end
...
%    rundir(1).dir='ecmwf_ml_0.5_nudging'; fileWRF(1).file=['met_em_d03-2006-01-03_00-00-00'];  %
 %   rundir(1).dir='ecmwf_ml_0.5'; fileWRF(1).file=['met_em_d02-2006-01-06_06-00-00'];  %
...
%    rundir(1).dir='ecmwf_ml_0.5'; fileWRF(1).file=['wrfinput_d02_2006-01-06_18-00-00'];   %
...
%    fileWRF(file_num(1)).file = [dire2 '/' fileWRF(file_num(1)).file];
