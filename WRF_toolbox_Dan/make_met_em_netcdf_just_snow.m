...
dir_netcdf = 'C:\Documents and Settings\dan\My Documents\WRF\ant_jan06_ecmwf_ncep_polar_nudging\'; %where the newly made files will be written
dir_ecmwf = 'Y:\WRF\ant_jan06_ecmwf_ncep_polar_nudging\'; %where the ecmwf files that contain the upper air data are
...
if iecmwf_soil==1        
   ...
   varstruct.Dimension={'Time','DateStrLen'};
	...
	varstruct.Dimension={'Time', 'south_north', 'west_east'};
		...
		varstruct.stagger = 'M';
        varstruct.Nctype = nc_float;  %float or int? was int, changed to float
