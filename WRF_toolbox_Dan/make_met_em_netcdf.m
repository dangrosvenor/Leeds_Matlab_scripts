...
dir_netcdf = 'Y:\WRF\ant_jan06_ecmwf_Nov08\'; %where the newly made files will be written
dir_ecmwf = 'Y:\WRF\jan06_met_orig\';         %where the ecmwf files that contain the upper air data are
