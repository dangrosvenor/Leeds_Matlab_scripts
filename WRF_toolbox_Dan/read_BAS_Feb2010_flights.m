...
flight_no=num2str(flight_choose);
...
case 'laptop'
	filename='C:\Documents and Settings\G\My Documents\MATLAB\WRF_toolbox_Dan\XY_latlon_v6.mat';
	flight_dir='C:\Documents and Settings\G\My Documents\Ohio2010\flight_data_3rd_time_lucky\';
    filename_CAS=['C:\Documents and Settings\G\CAPS_data_flight' flight_no '.mat'];
    load(filename_CAS);
    filename_terr='C:\Documents and Settings\G\terrain_data_WRF.mat';
    load(filename_terr);    
    date_str='';
    CAS_start_time_str='';
    
    filename_hdf5=['C:\Documents and Settings\G\hdf5_flight' flight_no '.mat'];
    load(filename_hdf5);
end
load(filename);
...
%          case 122
            ...
            eval(['[dat_flt' flight_str_read ',time_flt' flight_str_read ',qv_flt' flight_str_read '_fp,qv_flt' flight_str_read '_humi,dist_flt' flight_str_read ',X_flt' flight_str_read ',Y_flt' flight_str_read ']=read_BAS_Feb2010_flights_func(filename,16,X_latlon,Y_latlon,LATS,LONS);']);    
%    end
