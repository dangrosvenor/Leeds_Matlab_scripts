...
switch  str_pos
  ...
  case '13' %streamlines at 68.6 LAT for z0=1200m (14th June, 2010)
       %for d_perp = 400. 
        xaim=446e3;
        yaim=304e3;
        tol=1e3;      
        
   case '14' %streamlines at 67.5 LAT for z0=950m (14th June, 2010)
       %for d_perp = 400. 
        xaim=465e3;
        yaim=336e3;
        tol=1e3;        
        
   case '15' %streamlines at 68.1 LAT for z0=950m (14th June, 2010)
       %for d_perp = 400. 
        xaim=412e3;
        yaim=289e3;
        tol=1e3;            
        
   case '16' %streamlines at 68.1 LAT for z0=950m (14th June, 2010)
       %for d_perp = 400. 
        xaim=414e3;
        yaim=320e3;
        tol=1e3;   
...
%OR override here if know str_succ
str_succ=129;
