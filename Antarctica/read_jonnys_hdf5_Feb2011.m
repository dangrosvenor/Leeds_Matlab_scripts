...
file_name_h5='flight99\ice_size_dists_etc_flight99_Post_Jan2011_MAX_DOF.h5';
%%%%file_name_h5='flight100\ice_size_dists_etc_flight100.h5'; %NOT RIGHT - without max dof

%file_name_h5='flight100\ice_size_dists_etc_flight100_Post_Jan2011_MAX_DOF.h5';
file_name_h5='flight101\ice_size_dists_etc_flight101_Post_Jan2011_MAX_DOF.h5';
%file_name_h5='flight101\ice_size_dists_etc_flight101_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75.h5';
%file_name_h5='flight102\ice_size_dists_etc_flight102_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75.h5';
%file_name_h5='flight102\ice_size_dists_etc_flight102_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75_closed_particles_3.h5';
%file_name_h5='flight102\ice_size_dists_etc_flight102_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75_RECON_SAMPLE_AREA.h5';
%file_name_h5='flight117\ice_size_dists_etc.h5';
%file_name_h5='flight104\ice_size_dists_etc_flight104_Post_Jan2011_MAX_DOF.h5';
file_name_h5='flight104\ice_size_dists_etc_flight104_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75.h5';
%file_name_h5='flight104\ice_size_dists_etc_flight104_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75_TEST.h5';
file_name_h5='flight104\ice_size_dists_etc_flight104_Post_Jan2011_MAX_DOF_multRej_9_2ndary_area_0.75_TEST - CENTRE IN.h5';irecon=1;
file_name_h5='flight104\ice_size_dists_etc_flight104_Post_Jan2011_MAX_DOF_CENTRE-IN.h5';irecon=1;

%file_name_h5='flight105\ice_size_dists_etc_flight105.h5';
%file_name_h5='flight108\ice_size_dists_etc_flight108.h5';
%file_name_h5='flight113\ice_size_dists_etc_flight113.h5';

%file_name_h5='flight117\ice_size_dists_etc_flight117.h5';

%file_name_h5='flight120\ice_size_dists_etc_flight120.h5';
%file_name_h5='flight122\ice_size_dists_etc_flight122.h5';
%file_name_h5='flight123\ice_size_dists_etc_flight123.h5';
%file_name_h5='flight129\ice_size_dists_etc_flight129.h5';
...
ice_no_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(2)); %
round_no_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(5)); %
small_no_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(8)); %
ice_mass_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(3)); %
round_mass_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(6)); %
small_mass_Jonny = number_f2(1:end-1).*hdf5read(INFO.GroupHierarchy.Datasets(9)); %
