...
aws_name(idat).name='Esperanza';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Esperanza_station_data_01-09Jan2006.txt';
...
aws_name(idat).name='Bellingshausen';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Bellinghausen_station_data_01-09Jan2006.txt';
...
aws_name(idat).name='Marambio';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Marambio_station_data_01-09Jan2006.txt';
num_cols_aws(idat)=13; 

idat=11;
ALT_AWS(idat).dat = 11; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Faraday';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Faraday_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=12;
ALT_AWS(idat).dat = 0; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Butler';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Butler_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=13;
ALT_AWS(idat).dat = 16; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Rothera';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Rothera_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=14;
ALT_AWS(idat).dat = 10; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='O''Higgins';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\OHiggins_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=15;
ALT_AWS(idat).dat = 8; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Palmer';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Palmer_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=16;
ALT_AWS(idat).dat = 10; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Frei';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Frei_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=17;
ALT_AWS(idat).dat = 6; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Orcadas';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Orcadas_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=18;
ALT_AWS(idat).dat = 3; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Grytviken';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Grytviken_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=19;
ALT_AWS(idat).dat = 4; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='San Martin';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\SanMartin_station_data_01-09Jan2006_full.txt';
num_cols_aws(idat)=13; 

idat=20;
ALT_AWS(idat).dat = 39; %height in metres (according to http://www.antarctica.ac.uk/met/stations/manned_stations.html)
aws_name(idat).name='Halley';filename(idat).name='C:\Documents and Settings\dan\My Documents\logbook\Antarctica\station data\Halley_station_data_01-09Jan2006.txt';
num_cols_aws(idat)=13;
