...
function [H1,ax1,ax2]=plotXY3(xdat,ydat,labs,nmark,lwidth,leglor,logflag,xlab,ylab,ylims,zline,dual,secyA,secyB,lab2,iyys) %xdat(1:n).x, ydat(1:n).y & labs(1:n).l nmark=no markers
...
set(ax1,'Color','none');
%set(ax2,'xticklabel',[],'xtick',0,'box','off');
