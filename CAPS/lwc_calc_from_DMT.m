...
%N.B. - DMT log a non-constant boiling point of water - varies with pressure I guess?
iprint=0;
if iprint==1
...
% DAT Calculated (g/m^3)	
% DAT Observed (g/m^3)	
% LWC-DAT Calc (g/m^3)	  - this is the actual LWC, i.e. = FACT*(P-DRYP)
% LWC-DAT Observed(g/m^3)	, although the FACT value calculated here is a 
% Ambient Temp(C)           different to that in the spreadsheet.
% Pressure(mB)	
% Airspeed(m/s)	
% Air Density(kg/m^3)	
