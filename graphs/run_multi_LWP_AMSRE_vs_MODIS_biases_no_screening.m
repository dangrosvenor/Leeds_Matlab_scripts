...
%        xlabel('');
%        set(gca,'ylim',[3 7]);
         title(textwrap({'MOD35, absolute difference'},max_tit_wrap));
    end
...
%        set(gca,'ylim',[225 300]);
         title(textwrap({'MOD06, absolute difference'},max_tit_wrap));
     end
...
%        set(gca,'ylim',[225 300]);
         title('MOD35, percentage difference');
% ------------------------------         
    end
...
% ---- optional settings ------        
 %       xlabel('');
  %      set(gca,'ylim',[0.014 0.019]);
         title('MOD06, percentage difference');
    end
