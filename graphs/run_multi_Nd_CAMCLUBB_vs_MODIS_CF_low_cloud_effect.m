...
Nsub = 2;
Msub = 2;  %No. of panels Nsub = no. vert (no. rows), Msub = no. horiz (no. columns)
...
%        title(textwrap({'CAMCLUBBv2 vs MODIS all CF'},max_tit_wrap));
         title(textwrap({'All heights, CF>0.8'},max_tit_wrap));         
    end
...
%         title(textwrap({'CAMCLUBBv2 vs MODIS CF>0.8'},max_tit_wrap));
         title(textwrap({'All heights, all CF'},max_tit_wrap));         
     end
...
%         title('MOD35, r_e<14 \mum all CF');
        title(textwrap({'Low cloud only, CF>0.8'},max_tit_wrap));      
% ------------------------------         
    end
...
%         title('MOD06, r_e<14 \mum all CF');
        title(textwrap({'Low cloud only, all CF'},max_tit_wrap));      
    end
