...
% plot spokes
    ...
    plot(rmax*cs,rmax*sn,ls,'color',tc,'linewidth',1,...
     ...
     dan1=[60 30 0 330 300 270];
     dan2=[240 210 180 150 120 90];
...
%              'handlevisibility','off');
         ...
         text(rt*cst(i),rt*snt(i),int2str(dan1(i)),...
              'horizontalalignment','center',...
              'handlevisibility','off');
...
%              'handlevisibility','off')
         text(-rt*cst(i),-rt*snt(i),int2str(dan2(i)),'horizontalalignment','center',...
             'handlevisibility','off')
    end
