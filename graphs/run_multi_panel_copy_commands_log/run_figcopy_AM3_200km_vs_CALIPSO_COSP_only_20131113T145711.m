...
fcb_stretch = 1.7; %2.2
size_fac = 0.32;  %0.78; %0.85;
dY = 0.19; %0.105;  %0.09; %0.02; %distance to move the subplot upwards relative to papersize
dX = -0.10;
even_only_dX = 1; %flag to tell it to only move the odd numbered plot by dX
dY_cb = 0.46; %0.125;  %0.11; %distance to move the colorbars upwards
...
if stretch_cb==1
 ...
 xlabel(Hcb(1),'AM3 200km CALIPSO-COSP CF bias','fontsize',fontsize-4);
% % ------------------------------
