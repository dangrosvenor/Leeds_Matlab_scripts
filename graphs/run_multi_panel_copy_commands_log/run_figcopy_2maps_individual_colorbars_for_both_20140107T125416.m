...
fcb_stretch = 1.7; %2.2
size_fac = 0.9;  %0.27;  %0.78; %0.85;

dY = 0.08; %0.105;  %0.09; %0.02; %distance to move the subplot upwards relative to papersize
dX = -0.2;
...
%        set(gca,'ylim',[225 300]);
         title('CAMCLUBBv2');
           ...
           ylabel(hc_new(2),'Frequency','fontsize',fontsize-4);
