...
dY_cb = 0.14; %0.125;  %0.11; %distance to move the colorbars upwards
...
if stretch_cb==1
 ...
 xlabel(Hcb(1),'CAM5 model CF','fontsize',fontsize-4);
% % ------------------------------
...
if Ntot>=3
    ...
    xlabel(Hcb(3),'CAM5 COSP CALIPSO CF','fontsize',fontsize-4);
% ------------------------------
