...
fig_load{ifig} = 'Northern_NA_forcing_overall_2D_PDF_cf_PI_PD.fig'; 
idelete_cb{ifig}=1;
idelete_xlab{ifig}=1;
...
fig_load{ifig} = 'Southern_NA_forcing_overall_2D_PDF_cf_PI_PD.fig'; 
idelete_cb{ifig}=1;
idelete_xlab{ifig}=1;
idelete_ylab{ifig}=1;
idelete_xtick_labs{ifig}=1;
...
fig_load{ifig} = 'Northern_NA_NET_forcing_overall_2D_PDF_cf_PI_PD.fig'; 
idelete_cb{ifig}=1;
%ioverride_xticks{ifig}=[1:8];
%ioverride_yticks{ifig}=[1:8];
ifig=ifig+1;
...
fig_load{ifig} = 'Southern_NA_NET_forcing_overall_2D_PDF_cf_PI_PD.fig'; 
%idelete_cb{ifig}=1;
idelete_ylab{ifig}=1;
%ioverride_xticks{ifig}=[1:8];
%ioverride_yticks{ifig}=[1:8];
