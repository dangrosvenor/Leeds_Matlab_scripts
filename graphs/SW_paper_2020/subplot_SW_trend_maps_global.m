...
fig_tit{ifig} = 'Deep-C SWTOA trend';
fig_load{ifig} = 'global_Deep-C_SW_TOA_up_trend_1985_to_2014.fig';
% created using ACSIS_Robson_paper_multi_ENS_trend_maps.m
cbar_label{ifig} = 'W m^{-2} yr^{-1}';
idelete_cb{ifig}=1;
idelete_xlab{ifig}=1;
...
fig_tit{ifig} = 'UKESM1 ensemble SWTOA trend';
fig_load{ifig} = 'global_UKESM1_SW_TOA_up_trend_of_ensemble_mean_between_1985_and_2014;_W_.fig';
% created using ACSIS_Robson_paper_multi_ENS_trend_maps.m
cbar_label{ifig} = 'W m^{-2} yr^{-1}';
idelete_cb{ifig}=1;
idelete_xlab{ifig}=1;
...
fig_tit{ifig} = 'UKESM-AMIP SWTOA trend';
fig_load{ifig} = 'global_UKESM-AMIP_SW_TOA_up_trend_of_ensemble_mean_between_1985_and_2014.fig';
...
run_multi_file ='run_multi_SW_global_trend_maps';
eval(run_multi_file);
