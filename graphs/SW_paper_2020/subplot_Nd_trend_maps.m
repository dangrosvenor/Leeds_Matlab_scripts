...
fig_tit{ifig} = 'UKESM1 N_d trend 1850 to 1970';
fig_load{ifig} = 'UKESM_N_d_trend_of_ensemble_mean_between_y1850_and_y1970;_cm^-3_yr^-1.fig';
...
fig_tit{ifig} = 'UKESM1 N_d trend 2003 to 2014';
fig_load{ifig} = 'UKESM_N_d_trend_of_ensemble_mean_between_y2003_and_y2014;_cm^-3_yr^-1.fig';
% created using ACSIS_Robson_paper_multi_ENS_trend_maps.m
cbar_label{ifig} = 'cm^{-3} yr^{-1}';
idelete_cb{ifig}=0;
idelete_xlab{ifig}=1;
...
fig_tit{ifig} = 'MODIS N_d trend 2003 to 2014';
fig_load{ifig} = 'MODIS_N_d_trend_2003_to_2014.fig';
...
run_multi_file ='run_multi_Nd_trend_maps';
eval(run_multi_file);
