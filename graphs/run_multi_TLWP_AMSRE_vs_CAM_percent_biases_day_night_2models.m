...
Nsub = 2;  %no. plots in the vertical 
...
fcb_stretch = 1.7; %2.2
size_fac = 0.65; % 0.99; %0.85;
dY = 0.1;  %0.05 %distance to move the subplot upwards relative to papersize
dX = 0.0;
...
dY_cb = 0.13;  %0.11; %distance to move the colorbars upwards
dX_cb = 0.05; %0.05

dY_spacing = 0.15; %vertical spacing to add between plots, negative values add space
...
%        set(gca,'ylim',[225 300]);
         t2 = title(textwrap({'CAM5 % bias'},max_tit_wrap));
