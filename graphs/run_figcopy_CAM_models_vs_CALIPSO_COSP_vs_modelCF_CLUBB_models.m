...
fcb_stretch = 1.7; %2.2
size_fac = 0.68;  %0.78; %0.85;
dY = 0.14; %0.105;  %0.09; %0.02; %distance to move the subplot upwards relative to papersize
dX = -0.10;
even_only_dX = 1; %flag to tell it to only move the odd numbered plot by dX
dY_cb = 0.21; %0.125;  %0.11; %distance to move the colorbars upwards
...
if stretch_cb==1
 ...
 xlabel(Hcb(1),'CAMCLUBBv1','fontsize',fontsize-4);
% % ------------------------------
...
if Ntot>=3
    ...
    xlabel(Hcb(3),'CAMCLUBBv2','fontsize',fontsize-4);
% ------------------------------
