...
fcb_stretch = 1.7; %2.2
size_fac = 0.99; %0.85;
dY = -0.02;  %0.05 %distance to move the subplot upwards relative to papersize
dX = 0.0;
...
dY_cb = 0.01;  %0.11; %distance to move the colorbars upwards
dX_cb = 0.05; %0.05
...
%        xlabel('');
%        set(gca,'ylim',[3 7]);
         t1 = title(textwrap({'CAM5 % bias'},max_tit_wrap));
...
%        set(gca,'ylim',[225 300]);
         t2 = title(textwrap({'AM3 % bias'},max_tit_wrap));
...
%        set(gca,'ylim',[225 300]);
         title(textwrap({'CAM5CLUBBv1 % bias'},max_tit_wrap));
% ------------------------------         
    end
...
% ---- optional settings ------        
 %       xlabel('');
  %      set(gca,'ylim',[0.014 0.019]);
         title(textwrap({'AM3CLUBBv1 % bias'},max_tit_wrap));
    end
...
%        ylabel('$\theta_{2 km}$','interpreter','latex');
%        set(gca,'ylim',[225 300]);
         title(textwrap({'CAM5CLUBBv2 % bias'},max_tit_wrap));
% ------------------------------         
 end
...
%        ylabel('$\theta_{2 km}$','interpreter','latex');
%        set(gca,'ylim',[225 300]);
         title(textwrap({'AM3CLUBBv2 % bias'},max_tit_wrap));
% ------------------------------         
  end
