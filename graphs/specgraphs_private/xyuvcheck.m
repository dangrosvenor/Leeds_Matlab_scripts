...
%   [MSG,X,Y] = XYUVCHECK(X,Y,U,V) checks the input aguments
...
%   $Revision: 1.6.4.1 $  $Date: 2005/11/27 22:41:08 $
...
if min(sz)<2
  msg = makemsg('UVPlanar','U,V must all be size 2x2x2 or greater.'); 
  return
end
