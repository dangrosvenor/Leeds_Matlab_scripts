...
%finds points which satisfy Xbins(i)<=X<Xbins(i+1)
%So if want the final bin to contain X>Xbins(end) make Xbins(end) v. big
%N.B. - this funciton also adds a dummy row and column of zeros to end of the matrix
%to account for the fact that pcolor chops off the final row&column
